...
public class PostChallengePage extends TestBase{
	private static Logger log = LogManager.getLogger(PostChallengePage.class.getName());
	@FindBy(id="title")
	...
	{
		challengetitle.sendKeys(title);
	}
	public void setChallengeDescription(String desc)
	{   log.debug("Trying to switch to frame ");
		driver.switchTo().frame("description_ifr");
		log.debug("Switch to frame successful ");
		challengedescription.sendKeys(desc);
		log.debug("Challenge description is entered ");
	...
	public MyChallenges submitPublish()
	{
		publish.click();
		log.debug("Publish Challenge is clicked");
